...
for file in files:
    ...
    command = 'trimmomatic PE -threads 60 -phred33 ' + dir + file_r1 + ' ' + dir + file_r2 + ' ' + dir + file_r1_out + ' ' + dir + file_r2_out + ' ILLUMINACLIP:dataflow/00-meta/neb.fasta:2:30:10:2:keepBothReads LEADING:3 TRAILING:3 MINLEN:36'
