...
for file in files:
    ...
    command = 'trimmomatic PE -threads 60 -phred33 ' + dir + file_r1 + ' ' + dir + file_r2 + ' ' + dir + file_r1_out + ' /dev/null ' + dir + file_r2_out + ' /dev/null ILLUMINACLIP:neb.fasta:2:30:10:2:keepBothReads LEADING:5 TRAILING:5 MINLEN:36'
