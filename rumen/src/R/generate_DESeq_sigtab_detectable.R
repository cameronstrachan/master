...
df_metrics <- read.csv("~/master/rumen/dataflow/04-analysis-tables/henderson2015-20_320-97_df_metrics_lacto_det_500.csv")
...
write.csv(sigtab, "~/master/rumen/dataflow/04-analysis-tables/henderson2015-20_320-97_df_metrics_lacto_DESeq_sigtab_det_500.csv")