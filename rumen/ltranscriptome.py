...
if runbowtie == 'y':
    ...
    os.system("bowtie2 -p 40 -a --trim5 20 --trim3 20 --very-sensitive -x dataflow/03-bowtie/rumen_prevotella -1 dataflow/01-fastq/marre2017/SRX1585089_pass_1.fastq -2 dataflow/01-fastq/marre2017/SRX1585089_pass_2.fastq -S dataflow/03-bowtie/rumen_prevotella.sam")
