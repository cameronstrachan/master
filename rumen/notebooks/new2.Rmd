...
p=ggraph(mygraph, layout = 'dendrogram', circular = TRUE) +
  geom_conn_bundle(data = get_con(from = from3, to = to3, value=connect3$value), width=2, edge_colour = "skyblue") +
  geom_conn_bundle(data = get_con(from = from2, to = to2, value=connect2$value), width=2, edge_colour = "blue") +
  geom_conn_bundle(data = get_con(from = from1, to = to1, value=connect1$value), width=2, edge_colour = "black") + 
