...
# read in tree
tree <- read.tree("~/master/rumen/dataflow/03-trees/hsp70_mreB_eftu_dnaA_trimmed_tree_phyML_45genomes.newick") 

# couple labels to fix
...
df_pi$file1 <- gsub(".assembly", "", df_pi$file1)
df_pi$file2 <- gsub(".assembly", "", df_pi$file2)
...
plot_grid(recordedplot, heatmap.plot, mapped_reads.plot, align = 'h', ncol = 3, rel_widths = c(2,2,1))
```
