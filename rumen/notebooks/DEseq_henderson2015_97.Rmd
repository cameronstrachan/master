...
df_classification  <- read.csv("~/master/rumen/dataflow/03-asv-taxonomy/henderson2015-4_194-99-rdp.csv")
...
df <- read.delim("~/master/rumen/dataflow/03-asv-table/henderson2015-4_194-99.txt", skip = 1, header = TRUE)
df$clustering <- 99
