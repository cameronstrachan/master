...
df_ftTable <- read.delim("~/master/wolfcombined/dataflow/03-asv-table/feature-table-decontam.txt", 
...
```{r}
# read in meta data
df_meta <- read.csv("~/master/wolfcombined/dataflow/00-meta/sample-metadata.csv")
