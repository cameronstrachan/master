...
file_obj.setOutputName('cjejuni_hgt.txt')
file_obj.runblast(blast='blastn', db='campylobacter_jejuni', dblocation='blastdb/', max_target_seqs=1000, evalue=1e-5, num_threads = 30)
