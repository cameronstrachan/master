...
genomes <- c("clostridioides difficile", "clostridioides difficile dave", "campylobacter coli", "campylobacter jejuni", "staphylococcus aureus", "acinetobacter baumannii", "streptococcus pneumoniae", "pseudomonas aeruginosa", "listeria monocytogenes")
