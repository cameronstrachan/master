...
df_card_freq_sub$frequency_med_per_log <- as.numeric(round(log2((df_card_freq_sub$frequency_med / df_card_freq_sub$num_genomes) *100), 1))
```
...
plot_freq_wrap <- ggplot(df_card_freq_sub, aes(x=gene)) +
    theme_gdocs() +
    geom_point(aes(y = frequency_med_per_log, colour = num_versions),
