...
```{r}
df_card <- read.delim("~/master/rumen2/dataflow/02-blast-out/stewart2019_metagenomes_genes_1000_pathogen_mapped_card.txt", header=FALSE)
...
```{r}
file_in <- paste("~/master/rumen2/dataflow/03-analysis/stewart2019_metagenomes_genes_1000_clostridioides_difficile_dave.csv")
df_freq <- read.csv(file_in)
df_freq$X <- NULL
df_freq$file <- 'stewart2019_metagenomes_genes_1000_clostridioides_difficile_dave.csv'
