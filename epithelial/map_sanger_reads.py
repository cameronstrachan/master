...
file_obj = sc.Fasta('campy_1_assembled_16s.fasta', 'dataflow/01-nucl/')
file_obj.setOutputName('campy_1_assembled_16s_oneLine.fasta')
...
file = 'campy_1_assembled_16s_oneLine.fasta'
