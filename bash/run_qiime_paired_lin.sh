...
qiime vsearch cluster-features-de-novo \
  ...
  --o-clustered-table dataflow/02-qiime/table-dn-98.qza \
  --o-clustered-sequences dataflow/02-qiime/rep-seqs-dn-98.qza
...
qiime feature-table summarize \
  --i-table dataflow/02-qiime/table-dn-98.qza \
  --o-visualization dataflow/02-qiime/table-dn-98.qzv 
...
qiime feature-table tabulate-seqs \
  --i-data dataflow/02-qiime/rep-seqs-dn-98.qza \
  --o-visualization dataflow/02-qiime/rep-seqs-dn-98.qzv
