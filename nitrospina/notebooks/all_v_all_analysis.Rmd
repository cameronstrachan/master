...
colnames(df_compiled)[1:12] <- c("qseqid", "sseqid", "pident", "sstart", "send", "qstart", "qend", "evalue", "bitscore", "score", "qlen", "length")

df_compiled$file <- gsub(".txt", "", df_compiled$file)
df_compiled$file <- gsub(".rename", "", df_compiled$file)
df_compiled$file <- gsub("GCA_000341545.2", "GCA_0003415452", df_compiled$file)
...
df_headers$file1 <- gsub(".rename", "", df_headers$file1)
df_headers$file1 <- gsub("GCA_000341545.2", "GCA_0003415452", df_headers$file1)
...
df_complete <- df_complete %>%
  separate(qseqid, into = c("contig", "gene"), remove = FALSE)
```
