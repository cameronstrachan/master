---
title: "Zsofi's evolutionary question - Fecal data"
...
df_ftTable <- read.delim("~/master/wolf/dataflow/03-asv-table-merge/feature-table-no-contam-all-feces.txt", 
...
```{r}
# read in meta data
df_meta <- read.csv("~/master/wolfskin/dataflow/00-meta/sample-metadata-faeces.csv")
