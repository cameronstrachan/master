...
write.table(mat_final, '~/master/wolf/dataflow/03-asv-table-merge/feature-table-no-contam-pet-animals-skin.txt', col.names = FALSE, quote = FALSE, row.names = FALSE, sep = "\t")
```
