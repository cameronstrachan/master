...
def runqiimemerge(file1folder='wetzels2018', file2folder='wu2018'):
	...
	subprocess.call(['/Users/cameronstrachan/master/bash/merge_qiime.sh', str(table1), str(table2), str(seqs1), str(seqs2)])
	subprocess.call('/Users/cameronstrachan/master/bash/qiime_export_merge.sh')
	...
	os.rename('dataflow/dataflow/03-asv-table-merge/feature-table-100.txt', outputprefixstabs + '-100.txt')
	os.rename('dataflow/dataflow/03-asv-table-merge/feature-table-99.txt', outputprefixstabs + '-99.txt')
	os.rename('dataflow/dataflow/03-asv-table-merge/feature-table-97.txt', outputprefixstabs + '-97.txt')