...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
tree_order <- read.csv("~/master/for_anna/Tree_label_ordered_v2.csv")
...
df_rbh_final <- bind_rows(df_rbh_list) %>%
  ...
  filter(genome1 != "GCA_001273775.1_ASM127377v1") %>%
  filter(genome2 != "GCA_001273775.1_ASM127377v1") %>%
  
  filter(genome1 != "GCA_000243475.2_ASM24347v2") %>%
  filter(genome2 != "GCA_000243475.2_ASM24347v2") %>%
  
  filter(genome1 != "GCA_002009335.2_ASM200933v2") %>%
  filter(genome2 != "GCA_002009335.2_ASM200933v2") %>%
  
  filter(genome1 != "Nitrospina_vancouverensis") %>%
  filter(genome2 != "Nitrospina_vancouverensis") 
